...
mongoDBServer = 'mongodb+srv://covindia:kiran100#@cluster0.m0yrd.mongodb.net/myFirstDatabase?retryWrites=true&w' \
                '=majority '
# client = pymongo.MongoClient("localhost", 27017)
client = pymongo.MongoClient(mongoDBServer)
db = client["coronaData"]
...
def get_country_data(country_name):
    ...
    print(l)
    for i in l:
        if i.get(country_name, False):
            print(i[country_name])
            return {'data': i[country_name]}
